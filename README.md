...
通过可视化的统计数据、打卡激励机制，提升用户坚持习惯的动力。应用以简洁美观的UI设计、流畅的交互体验为核心，
覆盖“今日习惯打卡、全习惯管理、多维度统计分析”三大核心场景，支持习惯分类、目标设置、连续打卡记录、分类统计等功能，满足用户从习惯创建到长期追踪的全流程需求。
...
### （3）核心布局与标签页切换
功能说明
通过 Stack+Column 实现分层布局，基于 selectedTab 状态切换「今日习惯 / 全部习惯 / 统计」标签页，保证布局适配与层级管理。
### （4）习惯打卡功能
功能说明
校验打卡状态，计算连续天数，更新习惯数据和统计信息，给出 Toast 反馈。
### （5）新增习惯功能
功能说明
点击悬浮按钮弹出弹窗，输入习惯名称、选择分类 / 目标天数，校验后新增习惯并更新数据。
### （6）辅助功能
时段问候 ：根据一天内不同时间段，显示不同的问候语
日期计算：准确计算日期
删除习惯
...
- <img width="381" height="813" alt="屏幕截图 2025-12-16 160618" src="https://github.com/user-attachments/assets/51b16589-9f5d-466d-95e6-b9c155d0e2ea" />
...
<img width="358" height="552" alt="屏幕截图 2025-12-16 160651" src="https://github.com/user-attachments/assets/40cc6ed7-e888-410b-89f8-d9303e233da7" />
...
### 4. 消息页面
#### （1）
<img width="379" height="800" alt="屏幕截图 2025-12-16 160624" src="https://github.com/user-attachments/assets/7899b0ed-4088-4da0-a78e-7c36f0b8a53e" />
