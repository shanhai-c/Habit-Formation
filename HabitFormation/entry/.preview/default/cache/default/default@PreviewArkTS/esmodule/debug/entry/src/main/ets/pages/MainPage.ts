...
class MainPage extends ViewPU {
    ...
    initialRender() {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(32:5)", "entry");
            Column.width('100%');
            Column.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Swiper.debugLine("entry/src/main/ets/pages/MainPage.ets(43:7)", "entry");
            // 内容区域
    ...
    buildTopBar(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(77:5)", "entry");
            Row.width('100%');
            Row.padding({
                left: 20,
                right: 20,
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 用户信息
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(79:7)", "entry");
            // 用户信息
            Row.layoutWeight(1);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": 16777230, "type": 20000, params: [], "bundleName": "com.example.habitformation", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/pages/MainPage.ets(80:9)", "entry");
            Image.width(48);
            Image.height(48);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(91:9)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 根据时间段显示问候语
            Text.create(this.getGreetingByTime());
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(93:11)", "entry");
            // 根据时间段显示问候语
            Text.fontSize(14);
            // 根据时间段显示问候语
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(98:11)", "entry");
            // 用户名
            Text.fontSize(18);
            // 用户名
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            TextClock.create();
            TextClock.debugLine("entry/src/main/ets/pages/MainPage.ets(105:9)", "entry");
            // 在 buildTopBar() 方法的合适位置添加：
            TextClock.format('H');
            // 在 buildTopBar() 方法的合适位置添加：
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 通知和设置按钮
            Row.create({ space: 16 });
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(117:7)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/MainPage.ets(119:9)", "entry");
            Stack.onClick(() => {
                // 点击后标记为已读（可选）
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/MainPage.ets(120:11)", "entry");
            Image.width(24);
            Image.height(24);
        }, Image);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.getUnreadNotificationCount() > 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Circle.debugLine("entry/src/main/ets/pages/MainPage.ets(126:13)", "entry");
                        Circle.fill('#EF4444');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/MainPage.ets(137:9)", "entry");
            Image.width(24);
            Image.height(24);
            Image.onClick(() => {
    ...
    buildDateCard(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(159:5)", "entry");
            Column.width('92%');
            Column.padding(20);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(160:7)", "entry");
            Row.width('100%');
            Row.justifyContent(FlexAlign.Start);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.currentDate);
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(161:9)", "entry");
            Text.fontSize(16);
            Text.fontColor('#1E293B');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(166:9)", "entry");
            Text.fontSize(14);
            Text.fontColor('#64748B');
            Text.margin({ left: 12 });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 本周统计 - 使用实际数据
            Row.create({ space: 20 });
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(175:7)", "entry");
            // 本周统计 - 使用实际数据
            Row.width('100%');
            // 本周统计 - 使用实际数据
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(177:11)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('今日完成');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(181:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#64748B');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/pages/MainPage.ets(186:9)", "entry");
            Divider.height(40);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 4 });
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(188:9)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(this.statistics.totalHabits.toString());
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(189:11)", "entry");
            Text.fontSize(24);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('总习惯');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(193:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#64748B');
        }, Text);
        Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Divider.create();
            Divider.debugLine("entry/src/main/ets/pages/MainPage.ets(198:9)", "entry");
            Divider.height(40);
            Divider.color('#E2E8F0');
            Divider.vertical(false);
        }, Divider);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 4 });
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(200:9)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('完成率');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(205:11)", "entry");
            Text.fontSize(12);
            Text.fontColor('#64748B');
        }, Text);
        Text.pop();
    ...
    buildTabBar(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 0 });
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(243:5)", "entry");
            Row.width('92%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 今日习惯
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(245:7)", "entry");
            // 今日习惯
            Column.layoutWeight(1);
            // 今日习惯
            Column.onClick(() => {
                this.selectedTab = 0; // 只需要更新selectedTab，Swiper会自动切换
            });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('今日习惯');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(246:9)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.selectedTab === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Divider.create();
                        Divider.debugLine("entry/src/main/ets/pages/MainPage.ets(252:11)", "entry");
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 全部习惯
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(265:7)", "entry");
            // 全部习惯
            Column.layoutWeight(1);
            // 全部习惯
            Column.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('全部习惯');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(266:9)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.selectedTab === 1) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Divider.create();
                        Divider.debugLine("entry/src/main/ets/pages/MainPage.ets(272:11)", "entry");
                        Divider.color('#3B82F6');
                        Divider.height(3);
                        Divider.width(24);
                        Divider.margin({ top: 8 });
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 统计
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(285:7)", "entry");
            // 统计
            Column.layoutWeight(1);
            // 统计
            Column.onClick(() => {
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('统计');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(286:9)", "entry");
            Text.fontSize(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.selectedTab === 2) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Divider.create();
                        Divider.debugLine("entry/src/main/ets/pages/MainPage.ets(292:11)", "entry");
                        Divider.color('#3B82F6');
                        Divider.height(3);
                        Divider.width(24);
                        Divider.margin({ top: 8 });
    ...
    buildTodayHabits(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(314:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            ...
            if (this.habits.filter(h => h.isToday).length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/pages/MainPage.ets(317:9)", "entry");
                        // 空状态
                        Column.width('100%');
                        // 空状态
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/pages/MainPage.ets(318:11)", "entry");
                        Image.width(200);
                        Image.height(200);
                    }, Image);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('今天没有习惯任务');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(321:11)", "entry");
                        Text.fontSize(18);
                        Text.fontColor('#64748B');
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(324:11)", "entry");
                        Text.fontSize(14);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        List.debugLine("entry/src/main/ets/pages/MainPage.ets(332:9)", "entry");
                        // 习惯列表
                        List.width('100%');
                        // 习惯列表
                        List.height('100%');
                        ...
                        const forEachItemGenFunction = _item => {
                            const habit = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("entry/src/main/ets/pages/MainPage.ets(334:13)", "entry");
                                };
    ...
    buildAllHabits(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create();
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(353:5)", "entry");
            Column.width('100%');
            Column.height('100%');
            Column.padding({ left: 20, right: 20 });
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 分类筛选 - 使用 Scroll 组件实现水平滚动
            Scroll.create();
            Scroll.debugLine("entry/src/main/ets/pages/MainPage.ets(355:7)", "entry");
            // 分类筛选 - 使用 Scroll 组件实现水平滚动
            Scroll.width('100%');
            // 分类筛选 - 使用 Scroll 组件实现水平滚动
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create({ space: 8 });
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(356:9)", "entry");
            Row.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            const forEachItemGenFunction = _item => {
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(358:13)", "entry");
                    Text.fontSize(14);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.getFilteredHabits().length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Column.create({ space: 16 });
                        Column.debugLine("entry/src/main/ets/pages/MainPage.ets(379:9)", "entry");
                        Column.width('100%');
                        Column.height('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Image.create({ "id": 16777234, "type": 20000, params: [], "bundleName": "com.example.habitformation", "moduleName": "entry" });
                        Image.debugLine("entry/src/main/ets/pages/MainPage.ets(380:11)", "entry");
                        Image.width(200);
                        Image.height(200);
                    }, Image);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('暂无习惯');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(383:11)", "entry");
                        Text.fontSize(18);
                        Text.fontColor('#64748B');
                    }, Text);
                    Text.pop();
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(386:11)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#94A3B8');
                    }, Text);
                    Text.pop();
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        List.create({ space: 12 });
                        List.debugLine("entry/src/main/ets/pages/MainPage.ets(395:9)", "entry");
                        List.width('100%');
                        List.height('100%');
                        List.edgeEffect(EdgeEffect.Spring);
                    }, List);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            const habit = _item;
                            {
                                ...
                                const itemCreation2 = (elmtId, isInitialRender) => {
                                    ListItem.create(deepRenderFunction, true);
                                    ListItem.debugLine("entry/src/main/ets/pages/MainPage.ets(397:13)", "entry");
                                };
                                const deepRenderFunction = (elmtId, isInitialRender) => {
                                    itemCreation(elmtId, isInitialRender);
                        ...
                        this.forEachUpdateFunction(elmtId, this.getFilteredHabits(), forEachItemGenFunction, (habit: HabitData) => habit.id.toString(), false, false);
                    }, ForEach);
                    ForEach.pop();
                    List.pop();
                });
    ...
    buildStatisticsPage(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(424:5)", "entry");
            Column.width('100%');
    ...
    buildStatsOverview(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 16 });
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(442:5)", "entry");
            Column.width('92%');
            Column.padding(20);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(443:7)", "entry");
            Row.width('100%');
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('统计概览');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(444:9)", "entry");
            Text.fontSize(18);
            Text.fontColor('#1E293B');
            Text.fontWeight(FontWeight.Bold);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Grid.create();
            Grid.debugLine("entry/src/main/ets/pages/MainPage.ets(451:7)", "entry");
        ...
        }, Grid);
        {
            const itemCreation2 = (elmtId, isInitialRender) => {
                ...
                GridItem.debugLine("entry/src/main/ets/pages/MainPage.ets(452:9)", "entry");
            };
            const observedDeepRender = () => {
                this.observeComponentCreation2(itemCreation2, GridItem);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 4 });
                    Column.debugLine("entry/src/main/ets/pages/MainPage.ets(453:11)", "entry");
                    Column.width('100%');
                    Column.height(80);
                    Column.justifyContent(FlexAlign.Center);
                    Column.alignItems(HorizontalAlign.Center);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(this.statistics.totalHabits.toString());
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(454:13)", "entry");
                    Text.fontSize(24);
                    Text.fontColor('#3B82F6');
                    Text.fontWeight(FontWeight.Bold);
                }, Text);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('总习惯');
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(458:13)", "entry");
                    Text.fontSize(12);
                    Text.fontColor('#64748B');
                }, Text);
                Text.pop();
        ...
        }
        {
            const itemCreation2 = (elmtId, isInitialRender) => {
                GridItem.create(() => { }, false);
                GridItem.debugLine("entry/src/main/ets/pages/MainPage.ets(476:9)", "entry");
            };
            const observedDeepRender = () => {
                this.observeComponentCreation2(itemCreation2, GridItem);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 4 });
                    Column.debugLine("entry/src/main/ets/pages/MainPage.ets(477:11)", "entry");
                    Column.width('100%');
                    Column.height(80);
                    Column.justifyContent(FlexAlign.Center);
                    Column.alignItems(HorizontalAlign.Center);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(478:13)", "entry");
                    Text.fontSize(24);
                    Text.fontColor('#10B981');
                    Text.fontWeight(FontWeight.Bold);
                }, Text);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('今日完成');
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(482:13)", "entry");
                    Text.fontSize(12);
                    Text.fontColor('#64748B');
                }, Text);
                Text.pop();
        ...
        }
        {
            const itemCreation2 = (elmtId, isInitialRender) => {
                GridItem.create(() => { }, false);
                GridItem.debugLine("entry/src/main/ets/pages/MainPage.ets(500:9)", "entry");
            };
            const observedDeepRender = () => {
                this.observeComponentCreation2(itemCreation2, GridItem);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 4 });
                    Column.debugLine("entry/src/main/ets/pages/MainPage.ets(501:11)", "entry");
                    Column.width('100%');
                    Column.height(80);
                    Column.justifyContent(FlexAlign.Center);
                    Column.alignItems(HorizontalAlign.Center);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    ...
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(502:13)", "entry");
                    Text.fontSize(24);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('最长连续');
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(506:13)", "entry");
                    Text.fontSize(12);
                    Text.fontColor('#64748B');
                }, Text);
                Text.pop();
        ...
        }
        {
            const itemCreation2 = (elmtId, isInitialRender) => {
                GridItem.create(() => { }, false);
                GridItem.debugLine("entry/src/main/ets/pages/MainPage.ets(524:9)", "entry");
            };
            const observedDeepRender = () => {
                this.observeComponentCreation2(itemCreation2, GridItem);
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Column.create({ space: 4 });
                    Column.debugLine("entry/src/main/ets/pages/MainPage.ets(525:11)", "entry");
                    Column.width('100%');
                    Column.height(80);
                    Column.justifyContent(FlexAlign.Center);
                    Column.alignItems(HorizontalAlign.Center);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create(this.statistics.monthlyCompletionRate + '%');
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(526:13)", "entry");
                    Text.fontSize(24);
                    Text.fontColor('#8B5CF6');
                    Text.fontWeight(FontWeight.Bold);
                }, Text);
                ...
                this.observeComponentCreation2((elmtId, isInitialRender) => {
                    Text.create('完成率');
                    Text.debugLine("entry/src/main/ets/pages/MainPage.ets(530:13)", "entry");
                    Text.fontSize(12);
                    Text.fontColor('#64748B');
                }, Text);
                Text.pop();
            ...
            if (this.showAddHabitDialog) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 使用Stack来叠加遮罩层和对话框
                        Stack.create();
                        Stack.debugLine("entry/src/main/ets/pages/MainPage.ets(570:7)", "entry");
                        // 使用Stack来叠加遮罩层和对话框
                        Stack.width('100%');
                        // 使用Stack来叠加遮罩层和对话框
                        Stack.height('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 遮罩层
                        Column.create();
                        Column.debugLine("entry/src/main/ets/pages/MainPage.ets(572:9)", "entry");
                        // 遮罩层
                        Column.width('100%');
                        // 遮罩层
                        Column.height('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/pages/MainPage.ets(581:9)", "entry");
                        // 对话框内容
                        Column.width('80%');
                        // 对话框内容
                        Column.padding(24);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('添加新习惯');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(582:11)", "entry");
                        Text.fontSize(20);
                        Text.fontColor('#1E293B');
                        Text.fontWeight(FontWeight.Bold);
                    }, Text);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Column.debugLine("entry/src/main/ets/pages/MainPage.ets(588:11)", "entry");
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('习惯名称');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(589:13)", "entry");
                        Text.fontSize(14);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        TextInput.debugLine("entry/src/main/ets/pages/MainPage.ets(595:13)", "entry");
                        TextInput.width('100%');
                        TextInput.height(48);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 分类选择
                        Column.create({ space: 8 });
                        Column.debugLine("entry/src/main/ets/pages/MainPage.ets(608:11)", "entry");
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('分类');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(609:13)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#475569');
                        Text.width('100%');
                        Text.textAlign(TextAlign.Start);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 8 });
                        Row.debugLine("entry/src/main/ets/pages/MainPage.ets(615:13)", "entry");
                        Row.width('100%');
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(category);
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(617:17)", "entry");
                                Text.fontSize(14);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 目标天数
                        Column.create({ space: 8 });
                        Column.debugLine("entry/src/main/ets/pages/MainPage.ets(638:11)", "entry");
                    }, Column);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('目标天数');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(639:13)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#475569');
                        Text.width('100%');
                        Text.textAlign(TextAlign.Start);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Scroll.create();
                        Scroll.debugLine("entry/src/main/ets/pages/MainPage.ets(645:13)", "entry");
                        Scroll.width('100%');
                        Scroll.scrollable(ScrollDirection.Horizontal);
                        Scroll.scrollBar(BarState.Off);
                    }, Scroll);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Row.create({ space: 8 });
                        Row.debugLine("entry/src/main/ets/pages/MainPage.ets(646:15)", "entry");
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ForEach.create();
                        const forEachItemGenFunction = _item => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(days + '天');
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(648:19)", "entry");
                                Text.fontSize(14);
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 按钮
                        Row.create({ space: 12 });
                        Row.debugLine("entry/src/main/ets/pages/MainPage.ets(671:11)", "entry");
                        // 按钮
                        Row.width('100%');
                    }, Row);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Button.createWithLabel('取消');
                        Button.debugLine("entry/src/main/ets/pages/MainPage.ets(672:13)", "entry");
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/MainPage.ets(682:13)", "entry");
                        Button.layoutWeight(1);
                        Button.height(48);
    ...
    buildHabitRanking(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 16 });
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(713:5)", "entry");
            Column.width('92%');
            Column.padding(20);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('习惯坚持排行');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(714:7)", "entry");
            Text.fontSize(18);
            Text.fontColor('#1E293B');
            Text.fontWeight(FontWeight.Bold);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.habits.length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('暂无习惯数据');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(721:9)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#94A3B8');
                        Text.width('100%');
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = (_item, index: number) => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create({ space: 12 });
                                Row.debugLine("entry/src/main/ets/pages/MainPage.ets(729:11)", "entry");
                                Row.width('100%');
                                Row.padding(16);
                                Row.backgroundColor('#FFFFFF');
                                Row.borderRadius(12);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // 排名
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/MainPage.ets(731:13)", "entry");
                                // 排名
                                Column.width(40);
                                // 排名
                                Column.alignItems(HorizontalAlign.Center);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(732:15)", "entry");
                                Text.fontSize(16);
                                Text.fontColor('#64748B');
                                Text.fontWeight(FontWeight.Bold);
                            }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                if (index < 3) {
                                    this.ifElseBranchUpdateFunction(0, () => {
                                        this.observeComponentCreation2((elmtId, isInitialRender) => {
                                            Text.create(['🥇', '🥈', '🥉'][index]);
                                            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(738:17)", "entry");
                                            Text.fontSize(12);
                                        }, Text);
                                        Text.pop();
                                    });
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // 习惯图标
                                Stack.create();
                                Stack.debugLine("entry/src/main/ets/pages/MainPage.ets(746:13)", "entry");
                            }, Stack);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Circle.create();
                                Circle.debugLine("entry/src/main/ets/pages/MainPage.ets(747:15)", "entry");
                                Circle.width(48);
                                Circle.height(48);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Image.debugLine("entry/src/main/ets/pages/MainPage.ets(752:15)", "entry");
                                Image.width(24);
                                Image.height(24);
                            }, Image);
                            // 习惯图标
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // 习惯信息
                                Column.create({ space: 4 });
                                Column.debugLine("entry/src/main/ets/pages/MainPage.ets(758:13)", "entry");
                                // 习惯信息
                                Column.layoutWeight(1);
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(habit.name);
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(759:15)", "entry");
                                Text.fontSize(16);
                                Text.fontColor('#1E293B');
                                Text.fontWeight(FontWeight.Medium);
                            }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create({ space: 8 });
                                Row.debugLine("entry/src/main/ets/pages/MainPage.ets(764:15)", "entry");
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(habit.category);
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(765:17)", "entry");
                                Text.fontSize(12);
                                Text.fontColor('#64748B');
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(769:17)", "entry");
                                Text.fontSize(12);
                                Text.fontColor('#94A3B8');
                            }, Text);
                            Text.pop();
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Column.debugLine("entry/src/main/ets/pages/MainPage.ets(777:13)", "entry");
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(habit.currentStreak.toString());
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(778:15)", "entry");
                                Text.fontSize(18);
                                Text.fontColor('#10B981');
                                Text.fontWeight(FontWeight.Bold);
                            }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('天');
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(782:15)", "entry");
                                Text.fontSize(12);
                                Text.fontColor('#94A3B8');
                            }, Text);
                            Text.pop();
    ...
    buildCategoryStats(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 16 });
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(834:5)", "entry");
            Column.width('92%');
            Column.padding(20);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('分类统计');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(835:7)", "entry");
            Text.fontSize(18);
            Text.fontColor('#1E293B');
            Text.fontWeight(FontWeight.Bold);
            Text.width('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            if (this.getCategoryStatsData().length === 0) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('暂无分类数据');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(843:9)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#94A3B8');
                        Text.width('100%');
                        Text.textAlign(TextAlign.Center);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        const forEachItemGenFunction = _item => {
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Column.create({ space: 8 });
                                Column.debugLine("entry/src/main/ets/pages/MainPage.ets(851:11)", "entry");
                                Column.width('100%');
                                Column.padding({ top: 12, bottom: 12 });
                            }, Column);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/MainPage.ets(852:13)", "entry");
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create(stat.category);
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(853:15)", "entry");
                                Text.fontSize(16);
                                Text.fontColor('#1E293B');
                                Text.fontWeight(FontWeight.Medium);
                            }, Text);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(858:15)", "entry");
                                Text.fontSize(14);
                                Text.fontColor('#64748B');
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                // 进度条
                                Stack.create();
                                Stack.debugLine("entry/src/main/ets/pages/MainPage.ets(865:13)", "entry");
                            }, Stack);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/MainPage.ets(866:15)", "entry");
                                Row.width('100%');
                                Row.height(8);
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/MainPage.ets(872:15)", "entry");
                            ...
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Row.create();
                                Row.debugLine("entry/src/main/ets/pages/MainPage.ets(879:13)", "entry");
                            }, Row);
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                Text.create('完成率 ' + stat.completionRate + '%');
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(880:15)", "entry");
                                Text.fontSize(14);
                                Text.fontColor('#475569');
                            }, Text);
                            Text.pop();
                            this.observeComponentCreation2((elmtId, isInitialRender) => {
                                ...
                                Text.debugLine("entry/src/main/ets/pages/MainPage.ets(884:15)", "entry");
                                Text.fontSize(12);
                                Text.fontColor('#94A3B8');
                                Text.margin({ left: 'auto' });
                            }, Text);
    ...
    buildHabitCard(habit: HabitData, isToday: boolean, parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(910:5)", "entry");
            Column.width('100%');
            Column.padding(16);
            Column.backgroundColor('#FFFFFF');
            Column.borderRadius(16);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(911:7)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 习惯图标和名称
            Row.create({ space: 12 });
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(913:9)", "entry");
            // 习惯图标和名称
            Row.layoutWeight(1);
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 图标背景
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/MainPage.ets(915:11)", "entry");
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Circle.create();
            Circle.debugLine("entry/src/main/ets/pages/MainPage.ets(916:13)", "entry");
            Circle.width(48);
            Circle.height(48);
        }, Circle);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Image.create({ "id": -1, "type": -1, params: ['app.media.' + habit.icon], "bundleName": "com.example.habitformation", "moduleName": "entry" });
            Image.debugLine("entry/src/main/ets/pages/MainPage.ets(920:13)", "entry");
            Image.width(24);
            Image.height(24);
        }, Image);
        // 图标背景
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Column.create({ space: 4 });
            Column.debugLine("entry/src/main/ets/pages/MainPage.ets(926:11)", "entry");
        }, Column);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create(habit.name);
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(927:13)", "entry");
            Text.fontSize(16);
            Text.fontColor('#1E293B');
            Text.fontWeight(FontWeight.Medium);
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(931:13)", "entry");
            Text.fontSize(12);
            Text.fontColor('#64748B');
        }, Text);
        Text.pop();
            ...
            if (isToday && !habit.completed) {
                this.ifElseBranchUpdateFunction(0, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Button.debugLine("entry/src/main/ets/pages/MainPage.ets(940:11)", "entry");
                        Button.width(80);
                        Button.height(36);
                        Button.fontColor('#FFFFFF');
                        Button.fontSize(14);
                ...
                this.ifElseBranchUpdateFunction(1, () => {
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        // 已打卡状态
                        Row.create({ space: 4 });
                        Row.debugLine("entry/src/main/ets/pages/MainPage.ets(950:11)", "entry");
                        // 已打卡状态
                        Row.padding({
                            left: 12,
                            right: 12,
                    ...
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        ...
                        Image.debugLine("entry/src/main/ets/pages/MainPage.ets(951:13)", "entry");
                        Image.width(16);
                        Image.height(16);
                    }, Image);
                    this.observeComponentCreation2((elmtId, isInitialRender) => {
                        Text.create('已完成');
                        Text.debugLine("entry/src/main/ets/pages/MainPage.ets(955:13)", "entry");
                        Text.fontSize(14);
                        Text.fontColor('#10B981');
                    }, Text);
                    Text.pop();
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 进度信息
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(971:7)", "entry");
        }, Row);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 坚持天数
            Text.create('已坚持 ' + habit.currentStreak + ' 天');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(973:9)", "entry");
            // 坚持天数
            Text.fontSize(12);
            // 坚持天数
            Text.fontColor('#64748B');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            Text.create('目标 ' + habit.targetDays + ' 天');
            Text.debugLine("entry/src/main/ets/pages/MainPage.ets(977:9)", "entry");
            Text.fontSize(12);
            Text.fontColor('#64748B');
            Text.margin({ left: 'auto' });
        }, Text);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 进度条
            Stack.create();
            Stack.debugLine("entry/src/main/ets/pages/MainPage.ets(984:7)", "entry");
        }, Stack);
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 背景条
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(986:9)", "entry");
            // 背景条
            Row.width('100%');
            // 背景条
            Row.height(6);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            // 进度条
            Row.create();
            Row.debugLine("entry/src/main/ets/pages/MainPage.ets(993:9)", "entry");
            // 进度条
    ...
    buildFloatingActionButton(parent = null) {
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Stack.debugLine("entry/src/main/ets/pages/MainPage.ets(1021:5)", "entry");
            // 使用Stack并设置对齐方式为右下角
            Stack.width('100%');
            // 使用Stack并设置对齐方式为右下角
            Stack.height('100%');
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Button.debugLine("entry/src/main/ets/pages/MainPage.ets(1023:7)", "entry");
            // 主按钮
            Button.width(56);
            // 主按钮
            Button.height(56);
        ...
        this.observeComponentCreation2((elmtId, isInitialRender) => {
            ...
            Image.debugLine("entry/src/main/ets/pages/MainPage.ets(1039:7)", "entry");
            // 加号图标
            Image.width(24);
            // 加号图标
            Image.height(24);
            // 加号图标
            Image.position({ x: 16, y: 16 });
        }, Image);
        // 使用Stack并设置对齐方式为右下角
        Stack.pop();
    }
